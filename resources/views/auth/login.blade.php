...
<head>
    <meta charset="utf-8" />
    <title>Log In | Dyno Electrics Admin</title>
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-brand p-4">
                                    <a href="{{ url('/') }}" class="logo-dark">
                                        <img src="{{$siteSetting->logo ? $siteSetting->logo:''}}" alt="dark logo" height="100">
                                    </a>
                                </div>
...
<footer class="footer footer-alt fw-medium">
    <span class="text-dark">
        <script>document.write(new Date().getFullYear())</script> © Dyno Electrics
    </span>
</footer>
