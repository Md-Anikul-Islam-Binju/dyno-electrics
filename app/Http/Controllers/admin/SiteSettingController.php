...
class SiteSettingController extends Controller
{
        ...
        public function createOrUpdate(Request $request, $id = null)
        {
            ...
            $rules = [
                ...
                'favicon' => 'nullable|image|max:5120', // Adjust max file size as needed
                'logo' => 'nullable|image|max:5120', // Adjust max file size as needed
                'site_preview_image' => 'nullable|image|max:5120', // Adjust max file size as needed
